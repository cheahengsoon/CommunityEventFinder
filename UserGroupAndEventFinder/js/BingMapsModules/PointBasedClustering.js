...
********************************************************************************/
/*******************************************************************************
* Modified by Chad England
* September 25 2012
* changed cluster to return underlying pin data 
********************************************************************************/
                ...
                do {
                    ...
                    if (bounds.contains(clusters[i].center)) {
                        ...
                        if (c.dataIndices.length == 1) {
                            ...
                            var pinData = [];
                            var multiplePinId = c.dataIndices;
                            multiplePinId.forEach(function (r) {
                                pinData.push(_data[r]);
                            });

                            pin = _options.clusteredPinCallback(pinData,c);
                        }
